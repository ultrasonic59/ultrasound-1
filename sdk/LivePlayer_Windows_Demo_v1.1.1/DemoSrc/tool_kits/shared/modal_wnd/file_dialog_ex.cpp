...
void CFileDialogEx::SetFilter(std::map<LPCTSTR,LPCTSTR>& filters)
{
	...
	const int size = filters.size()*500;
...
void CFileDialogEx::AsyncShowOpenFileDlg(FileDialogCallback2 file_dialog_callback2)
{
...
void CFileDialogEx::AsyncShowSaveFileDlg(FileDialogCallback2 file_dialog_callback2)
{
	file_dialog_callback2_ = file_dialog_callback2;
...
std::wstring CFileDialogEx::AsyncShowChooseDirDlg(HWND parent, const wchar_t* lpszTitle)
{
...
CFileDialogEx::POSITION CFileDialogEx::GetStartPosition()
{
