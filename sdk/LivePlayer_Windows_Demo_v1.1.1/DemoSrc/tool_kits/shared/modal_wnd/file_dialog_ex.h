...
public:
	...
	void AsyncShowOpenFileDlg(FileDialogCallback2 file_dialog_callback1);
	void AsyncShowSaveFileDlg(FileDialogCallback2 file_dialog_callback1);
	static std::wstring AsyncShowChooseDirDlg(HWND parent_wnd, const wchar_t* lpszTitle); //Ñ¡ÔñÎÄ¼þ¼Ð
